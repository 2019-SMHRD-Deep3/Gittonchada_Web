...
<div class="card-header" style="margin-top: 0px; margin-left: 0px;">
				...
				<form action="NoticeWriteCon.do">
					<div class="form-group">
						<label for="exampleFormControlInput1">아이디</label> <input
							type="text" class="form-control" id="exampleFormControlInput1"
							name="notice_id" placeholder="" value="관리자">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="exampleFormControlTextarea1">공지</label>
						<textarea class="form-control" id="exampleFormControlTextarea1"
							name="notice_content" rows="10" placeholder="내용을 입력하세요"></textarea>
					</div><br>
					<div class="form-group" style="text-align:center;">
						<button type="button" class="btn btn-primary" onclick="location.href='board_notice.jsp'">뒤로가기</button>
